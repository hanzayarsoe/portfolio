      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          {projectsData.map((project) => (
            ...
            >
              <div className={`relative flex aspect-square w-full items-center justify-center overflow-hidden p-3 ${project.color} lg:p-4`}>
                ...
                <img
                  ...
                  className="relative z-20 h-full w-full rounded-2xl object-cover shadow-xl transition-transform duration-700 transform group-hover:scale-105"
                />
              ...
              <div className="flex grow flex-col p-5 sm:p-6">
                ...
                <h4 className="mb-3 text-xl font-bold transition-colors group-hover:text-primary sm:text-2xl">
                  {project.title}
                </h4>
                <p className="text-sm leading-relaxed text-slate-600 dark:text-slate-400 line-clamp-3 sm:text-base">
                  {project.description}
                </p>
                <div className="mt-5 flex flex-wrap gap-3">
                  {project.demoUrl && (
                    <a
                      ...
                      className="min-w-[6.5rem] flex-1 rounded-lg bg-primary px-3 py-2 text-center text-sm font-bold text-white transition-all hover:shadow-lg hover:shadow-primary/30"
                  ...
                  {project.githubUrl && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="min-w-[6.5rem] flex-1 rounded-lg border-2 border-slate-200 px-3 py-2 text-center text-sm font-bold text-slate-700 transition-all hover:border-primary hover:text-primary dark:border-slate-800 dark:text-slate-300"
                      onClick={(e) => e.stopPropagation()}
                    >
                      GitHub
                    </a>
                  ...
                  {project.playStoreUrl && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="min-w-[6.5rem] flex-1 rounded-lg bg-[#01875F] px-3 py-2 text-center text-sm font-bold text-white transition-all hover:shadow-lg hover:shadow-[#01875F]/30"
                      onClick={(e) => e.stopPropagation()}
                    >
                      Play Store
                    </a>
                  ...
                  {project.appStoreUrl && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="min-w-[6.5rem] flex-1 rounded-lg border-2 border-slate-900 bg-slate-900 px-3 py-2 text-center text-sm font-bold text-white transition-all hover:shadow-lg dark:bg-white dark:text-slate-900"
                      onClick={(e) => e.stopPropagation()}
                    >
                      App Store
                    </a>
