  ...
  return (
    <div className="bg-background-light dark:bg-background-dark font-display text-slate-900 dark:text-slate-100 min-h-screen selection:bg-primary/30 flex flex-col">
      ...
      <main className="flex-grow">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <h1 className="text-5xl lg:text-7xl font-black leading-tight tracking-tight">
                Hi, I am <span className="text-primary">Han Zayar Soe</span>,
                Flutter Developer.
              </h1>
              <p className="text-lg text-slate-600 dark:text-slate-400 leading-relaxed max-w-2xl">
                Dedicated and adaptable Flutter Developer with a Bachelor of
                Computer Science (B.C.Sc) and a proven track record of designing
                and deploying cross-platform applications for Android and iOS.
                Award-winning university developer with solid professional
                experience utilizing Dart, Clean Architecture, and advanced
                state management (BLoC, Riverpod, Provider). Highly skilled in
                integrating REST APIs, Firebase, offline storage, and
                implementing mobile security best practices.
              </p>
              <div className="flex flex-wrap gap-4 pt-4">
                <a
                  href="#experience"
                  className="bg-primary text-white px-8 py-4 rounded-lg font-bold hover:shadow-lg hover:shadow-primary/30 transition-all flex items-center gap-2"
                >
                  View My Work{" "}
                  <span className="material-symbols-outlined">
                    arrow_forward
              ...
              >
                ...
                <div className="min-w-full p-8 md:p-12 flex flex-col md:flex-row gap-8 items-center justify-center border-none">
                  ...
                  <div className="flex flex-col w-full md:w-1/2 space-y-4">
                    ...
                    <div className="flex items-center gap-4">
                      <span className="px-3 py-1 bg-slate-800 text-white dark:bg-slate-200 dark:text-slate-900 text-xs font-bold rounded-full">
                        2024
                      </span>
                    ...
                    <p className="text-slate-600 dark:text-slate-400 text-lg leading-relaxed">
                      A dynamic web application built using Python to showcase
                      resources, culture, or services related to Myeik. It
                      features a responsive layout and robust backend
                      integration optimized for seamless content delivery.
                    </p>
                  </div>
                </div>
                ...
                <div className="min-w-full p-8 md:p-12 flex flex-col md:flex-row gap-8 items-center justify-center border-none">
                  ...
                  <div className="flex flex-col w-full md:w-1/2 space-y-4">
                    ...
                    <p className="text-slate-600 dark:text-slate-400 text-lg leading-relaxed">
                      An efficient human resources management system engineered
                      in C++. It focuses on high-performance data structures and
                      secure handling of personnel records for internal business
                      administration.
                    </p>
                  </div>
                </div>
                ...
                <div className="min-w-full p-8 md:p-12 flex flex-col md:flex-row gap-8 items-center justify-center border-none">
                  ...
                  <div className="flex flex-col w-full md:w-1/2 space-y-4">
                    ...
                    <p className="text-slate-600 dark:text-slate-400 text-lg leading-relaxed">
                      A high-speed utility application designed for
                      point-of-sale calculations or reward systems. Utilizing
                      C++ enables extremely low latency processing for real-time
                      transactions.
                    </p>
                  </div>
                </div>
                ...
                <div className="min-w-full p-8 md:p-12 flex flex-col md:flex-row gap-8 items-center justify-center border-none">
                  ...
                  <div className="flex flex-col w-full md:w-1/2 space-y-4">
                    ...
                    <p className="text-slate-600 dark:text-slate-400 text-lg leading-relaxed">
                      A robust back-office application built for inventory and
                      merchant management. Leveraging C++, it effectively
                      handles massive datasets and intricate business logic
                      optimizations.
                    </p>
                  </div>
                </div>
        ...
        <footer
          className="px-6 pt-24 pb-12 bg-background-light dark:bg-background-dark border-t border-slate-200 dark:border-slate-800"
          id="contact"
        >
          <div className="max-w-7xl mx-auto">
